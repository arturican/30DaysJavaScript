...
const convertHexaToRgb = (hexa) => {
    ...
    if (str[0] === '#') {
        ...
        let firstNumber = str2.slice(0,2);
        let secondNumber = str2.slice(2,4);
        let thirdNumber = str2.slice(4,6);
        return console.log(firstNumber,secondNumber,thirdNumber)
    }

}

convertHexaToRgb('#1adsad');